...
\begin{enumerate}
	...
	\vspace{0.5cm}
	\item Calcule as \'areas das regi\~oes abaixo, onde $x\in[1,2]$:

		\begin{enumerate*}
			\item \includegraphics[width=5cm]{lista-06-fig1.png}
			\hspace{1cm}
			\hspace{1cm}
			\item \includegraphics[width=5cm]{lista-06-fig2.png}
		\end{enumerate*}
\end{enumerate}
\end{document}
